...
![A Claude Code prompt which reads: "We are trapped in the belly of this horrible machine, and the machine is bleeding to death"](/assets/images/horrible-machine/claude-prompt.png)

Heard in a meeting about being forced to use AI at work against our personal values:
